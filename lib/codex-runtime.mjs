...
export class CodexRuntime extends EventEmitter {
  ...
  async #startProcess() {
    ...
    await this.request("initialize", {
      clientInfo: {name: "marketing_research_companion", title: "Marketing Research Companion", version: "2.2.0"},
  ...
  async runImageGeneration({prompt, cwd = this.cwd, model = "gpt-5.6-terra", effort = "high", signal, onEvent}) {
    const account = await this.getAccount({refresh: true});
    if (account?.type !== "chatgpt") throw Object.assign(new Error("ChatGPT 계정을 먼저 연결해 주세요."), {statusCode: 401});
