...
const salesEstimate = {
  type: "object",
  additionalProperties: false,
  required: ["method", "period", "basis", "formula", "inputs", "priceBasis", "demandSignals", "assumptions", "low", "base", "high", "confidence", "sourceRefs", "limitations"],
  properties: {
    method: {type: "string", enum: ["official_sales", "order_count", "review_backcast", "traffic_backcast", "engagement_backcast", "insufficient"]},
    period: {type: "string"},
    basis: {type: "string"},
    formula: {type: "string"},
    inputs: stringArray,
