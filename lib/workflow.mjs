...
export async function runResearchJob({jobId, store, provider, signal}) {
  ...
  try {
    ...
    const artifacts = await store.writeReport(jobId, html, {request, report, sources, quality, mode: starting.mode, model: starting.model, reasoningEffort: starting.reasoningEffort});
